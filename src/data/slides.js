...
const slides = [
  {
    id: uid(),
    img: "/assets/demon-slayer-tanjiro-with-katana-epic-desktop-wallpaper.jpg",
    name: "Tanjiro Kamado",
    quote:
      "Never again will I let anyone suffer the way we did! NO ONE should have to bear that kind of grief!",
  },
  {
    id: uid(),
    img: "/assets/cropped-1920-1080-1343746.png",
  ...
  {
    id: uid(),
    img: "/assets/inosuke-demon-slayer-epic-anime-desktop-wallpaper-4k.jpg",
    name: "Inosuke Hashibira",
    quote:
      "Don't dwell on such weak thoughts! You can or you can't, it doesn't do you any good to sit there, wondering about the maybes! Everything that dies returns to the earth, but crying won't bring any of them back, so no matter how frusturated you feel, don't cry! Even if you think you're wretched and unworthy... you must keep on living!",
  },
  {
    id: uid(),
    img: "/assets/demon-slayer-giyu-tomioka-cool-desktop-wallpaper-4k.jpg",
    name: "Giyu Tomioka",
    quote: "Do not let others hold the right to decide if you live or die!!",
  },
  {
    id: uid(),
    img: "/assets/kimetsu-no-yaiba-rengoku-with-katana-desktop-wallpaper.jpg",
  ...
  {
    id: uid(),
    img: "/assets/demon-slayer-mitsuri-cherry-blossom-desktop-wallpaper.jpg",
