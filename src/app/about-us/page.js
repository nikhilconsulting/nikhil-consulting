    ...
    <section className="relative w-full min-h-screen flex flex-col justify-center py-16 px-4 sm:px-8 md:px-16 lg:px-20 "
     style={{
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-6">
        ...
        {/* Left Side - Blob Image with Gradient Background Blob */}
        <div className="relative w-full max-w-[600px] h-[400px] mx-auto">
          ...
          <div
            className="w-full h-full border-8 border-orange-300 overflow-hidden "
          ...
          <div className="absolute top-4 left-4 bg-[linear-gradient(90deg,#5F69A8,#616FB4,#657AC9,#6E8EEE,#80B3F6,#8FCDFF)] backdrop-blur-[15px] rounded-full px-6 py-4 shadow-lg text-center z-10">
