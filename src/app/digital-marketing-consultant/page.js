...
export default function Page() {
  ...
  return (
    <>
      ...
      <meta
        name="keywords"
        content="contact Blue Coast Wellness, get in touch, health plans support, customer service, contact us, Blue Coast Wellness Group, inquiries, health plan inquiries, health plans assistance, wellness solutions"
      />
