...
export default function Pricing() {
  ...
  return (
    <div className="relative bg-black/10 min-h-screen py-12 px-4 sm:px-6 lg:px-8 font-sans flex flex-col items-center justify-center">
      ...
      {/* Pricing Cards */}
      <div className="relative z-10 mt-12 grid gap-8 max-w-6xl mx-auto md:grid-cols-3 items-start px-4">
        {plans.map((plan) => (
          <div
            key={plan.name}
            className={`rounded-3xl p-10 flex flex-col transform transition-transform duration-500 hover:scale-[1.02] origin-center ${
              plan.popular
