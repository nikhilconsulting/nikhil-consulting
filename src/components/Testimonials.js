      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div>
          <span className="text-5xl sm:text-5xl font-bold mb-3 text-gray-100 leading-snug block">
            What Our <br />
            <span className="text-gray-100">Clients Say !</span>
          </span>
        ...
        <div className="flex flex-col gap-4">
          {testimonials.map((t, i) => (
             <div
    key={i}
    className={`group relative flex items-start shadow-md text-white p-3 sm:p-4 bg-[linear-gradient(90deg,#5F69A8,#616FB4,#657AC9,#6E8EEE,#80B3F6,#8FCDFF)] transition-transform duration-300 border-l-4 border-gray-100
